...
Widget build(BuildContext context) {
  return Scaffold(
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(10),
                                    image: DecorationImage(
                                      image: AssetImage('assets/images/Logo-Kasmini.jpg'),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                                  ...
                                  FutureBuilder<List<TransactionData>>(
                                    ...
                                    builder: (context, snapshot) {
                                      if (snapshot.connectionState == ConnectionState.waiting) {
                                        ...
                                        final lastTransaction = snapshot.data!.last;
                                        return Text(
                                          "# ${lastTransaction.transactionId}",
                                          style: GoogleFonts.poppins(
                                            fontSize: 14,
                                  ...
                                  FutureBuilder<List<TransactionData>>(
                                    ...
                                    builder: (context, snapshot) {
                                      if (snapshot.connectionState == ConnectionState.waiting) {
                                        ...
                                        final lastTransaction = snapshot.data!.last;
                                        return Text(
                                          lastTransaction.transactionCustomerName,
                                          style: GoogleFonts.poppins(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.black,
    ...
    // floatingActionButton: ExpensiveFloatingButton(onPressed: _captureAndShareImage, text: "BAGIKAN"),
