                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      ExpenseCard.truncate(widget.title,
                                      length: 15
                                      ),
                                    ...
                                    Text(
                                      ExpenseCard.truncate(widget.amount,
                                ...
                                Text(ExpenseCard.truncate(widget.note,
                                    length: 15,
                                ...
                                Expanded(
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        "Pengeluaran pada ${ExpenseCard.truncate(widget.date)}",
                                        style: GoogleFonts.poppins(
                                            fontSize: 12,
                                            color: Colors.black,
